...
public class VMenuLayout extends LinearLayout {
    ...
    */
    ...
    public VMenuLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public VMenuLayout(Context context) {
        super(context);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        content.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                return VMenuLayout.this.onContentTouch(v, event);
            }
        });
